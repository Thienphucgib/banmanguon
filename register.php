            ...
            <div class="auth-box row">
                ...
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <p class="text-center">Enter your email, account and password to access website.</p>
                        <form class="mt-4" id="register_sieuthicode">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="uname">Email</label>
                                        <input class="form-control" id="email" name="email" type="email" placeholder="Nhập địa chỉ email">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="uname">Tài khoản</label>
                                        <input class="form-control" id="user" name="user" type="text" placeholder="Nhập tài khoản">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12 text-center">
                                    <button type="submit" id="reg_submit" class="btn btn-block btn-dark">Đăng Ký</button>
                                </div>
